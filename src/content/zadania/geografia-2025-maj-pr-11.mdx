...
1. **Pilica** (zbiornik Sulejowski → Łódź)
...
<div class="pulapka">
  ...
  **Bug to dopływ Wisły czy Narwi?** Klasyk pytania! Bug **wpada do Narwi** koło Serocka, **NIE bezpośrednio do Wisły**. Narew (+ Bug w sobie) wpada do Wisły. Bug jest dłuższy od Narwi — paradoks hydrograficzny.

  **Pomylenie pradoliny ze zbiornikiem.** Pradolina = stara dolina wykorzeniona przez wody roztopowe lodowca. Warta przepływa przez kilka pradolin (Toruńsko-Eberswaldzka, Warszawsko-Berlińska).

  **Pomylenie obszarów staroglacjalnych z młodoglacjalnymi.** **Staroglacjalne** = zlodowacenia starsze (>20 tys. lat, południe Polski). **Młodoglacjalne** = ostatnie zlodowacenie (Pojezierza). Klucz: **morena czołowa** ostatniego zlodowacenia oddziela oba obszary.
</div>
