...
tresc: |
  ...
  **Tekst 1** — *Rozmowa Mistrza Polikarpa ze Śmiercią* (fragment): Śmierć przepowiada, że w dzień sądny dobre życie zostanie nagrodzone, a marne ubrania i pozory doczesne („obłudne jimienie") nie pomogą. „A my jidzim przez otwłoki" (a my odejdziemy bez zwłoki).

  **Tekst 2** — Jan Andrzej Morsztyn, *Wiosna*: „Spieszmy się, spieszmy, niż nas czas nadgoni / I śmierć […]. Żyj w skok, bo-ć zamknął do niezmiernej wrota / Nadzieje krótki kres dany żywota; / Zarwij, co możesz, dobrych dni pod miarą, / Wnet będziesz bajką, nieboszczykiem, marą."

  **7.1 (0-1)** — Wyjaśnij, czym się różni postawa życiowa zalecana we fragmencie *Rozmowy Mistrza Polikarpa* od postawy życiowej zalecanej we fragmencie *Wiosny* Morsztyna.

  **7.2 (0-1)** — Podaj nazwę epoki, w której powstała *Rozmowa Mistrza Polikarpa*, oraz wykaż zgodność postawy zalecanej w tekście ze światopoglądem epoki.
odpowiedz: |
