...
difficulty: 5
tresc: |
  Reakcja: **X₂(g) + 2 Y₂(g) → 2 XY₂(g)**. Równanie kinetyczne: v = k · c_X₂^a · c_Y₂^b.

  Wykres: v vs stężenie X₂ (przy c_Y₂=1) — **liniowa** (czerwona). v vs c_Y₂ (przy c_X₂=1) — **parabola** (zielona).

  Z wykresu: c=1, v=1; c_X₂=2, v=2; c_Y₂=2, v=4.

  **10.1.** P/F: 1) zmniejszenie V w izotermii → wzrost v? 2) wzrost T w izobarii → spadek v?

  **10.2.** Wyznacz **a, b**, oblicz **k**, oblicz szybkość gdy w reaktorze 4 dm³ łącznie **9,0 mol** gazów (start: stechiometryczna mieszanina 12,0 mol).
odpowiedz: |
  **10.1.**
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-14.webp"
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-15.webp"
  alt="Zadanie 10.2"
  caption="Strona 15 arkusza CKE 2025 PR chemia - zadanie 10.2 (obliczenia)."
  zrodlo="CKE 2025"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2025/Chemia/MCHP-R0-100-A-2505-arkusz.pdf"
  pdfPage={15}
/>
