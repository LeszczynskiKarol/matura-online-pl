...
difficulty: 5
tresc: |
  Dany jest trójkąt ABC, który nie jest równoramienny. W tym trójkącie miara kąta ABC jest dwa razy większa od miary kąta BAC. Wykaż, że długości boków tego trójkąta spełniają warunek |AC|² = |BC|² + |AB| · |BC|.
odpowiedz: |
