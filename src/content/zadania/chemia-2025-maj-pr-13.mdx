...
difficulty: 5
tresc: |
  Synteza amoniaku w reaktorze o **stałej objętości** w temperaturze T:

  N₂ + 3 H₂ ⇌ 2 NH₃

  **Dane**: c(N₂)₀ = 0,20 mol/dm³, c(H₂)₀ = 0,60 mol/dm³. Po pewnym czasie ciśnienie spadło do **75%** początkowej wartości.

  Oblicz **stężeniową stałą równowagi K_c**.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-18.webp"
...
- **K_c >> 1**: równowaga przesunięta w prawo (dużo produktów).
- **K_c << 1**: równowaga w lewo (dużo substratów).
