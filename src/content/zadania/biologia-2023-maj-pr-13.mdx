...
difficulty: 4
tresc: |
  **PCR** (Polymerase Chain Reaction) = łańcuchowa reakcja polimerazy. 3 etapy cyklu:
  - **Etap 1**: rozdzielenie nici DNA (denaturacja).
  - **Etap 2**: przyłączenie starterów (annealing).
  - **Etap 3**: synteza DNA (elongacja) — polimeraza DNA + dGTP + dTTP + ...

  **13.1.** Uzupełnij schemat — brakujące deoksyrybonukleotydy.
  **13.2.** Jak rozdziela się dwuniciowy DNA w pierwszym etapie cyklu?
  **13.3.** Dlaczego synteza DNA musi być poprzedzona przyłączeniem starterów? Uwzględnij właściwości polimerazy DNA.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-22.webp"
