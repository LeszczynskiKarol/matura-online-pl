...
difficulty: 4
tresc: |
  Synteza **feksofenadyny** (leku przeciwhistaminowego) — końcowy etap: redukcja grupy karbonylowej **C=O** w substracie → **CH-OH** w produkcie (feksofenadynie) przez NaBH₄.

  Uzupełnij:
  - Redukcja 1 mola substratu wymaga (dwóch / trzech) moli elektronów.
  - Hybrydyzacja C ulegającego redukcji w substracie: (sp / sp² / sp³).
  - Hybrydyzacja tego samego C w produkcie: (sp / sp² / sp³).
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-27.webp"
...
- Redukcja 1 mola substratu wymaga **DWÓCH** moli elektronów (zmiana s.u. C: +2 → 0).
- Hybrydyzacja C w substracie: **sp²** (keton, 3 wiązania σ + 1 π).
- Hybrydyzacja C w produkcie: **sp³** (alkohol, 4 wiązania σ).
