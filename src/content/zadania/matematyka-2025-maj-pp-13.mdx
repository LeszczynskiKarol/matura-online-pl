...
difficulty: 2
tresc: |
  Funkcja liniowa $f$ jest określona wzorem $f(x) = (3 - m) x - 4$. Funkcja $f$ **nie ma** miejsca zerowego dla $m$ równego: A. $(-3)$, B. $0$, C. $3$, D. $4$.
odpowiedz: |
  C — $m = 3$
pulapka: |
...
<MaterialZrodlowy
  src="/arkusze/matematyka/2025-maj-pp/ark-14.webp"
