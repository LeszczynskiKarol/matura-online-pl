...
<div class="pulapka">
  ...
  **Pomylenie Staropolskiego OP ze Śląskiem.** Staropolski to **świętokrzyskie** (Góry Świętokrzyskie). Górny Śląsk to **GOP** (Górnośląski Okręg Przemysłowy) — inna lokalizacja, inne surowce.

  **Pomylenie Huty Kraków z Hutą Częstochowa.** Huta Częstochowa (Bobrek-Tarnowskie Góry) — bliżej rud Śląska. Huta Kraków — bez lokalnych rud, decyzja polityczna.

  **Niedocenienie decyzji politycznych jako czynnika lokalizacji.** W gospodarce PRL **plan centralny** często łamał logikę ekonomiczną.
</div>
