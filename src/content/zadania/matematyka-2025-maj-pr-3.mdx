...
difficulty: 5
tresc: |
  W trójkącie równobocznym $ABC$ punkt $D$ leży na boku $BC$. Stosunek pola trójkąta $ABD$ do pola trójkąta $ADC$ jest równy $\dfrac{\sqrt{3} - 1}{2}$. Oblicz miarę kąta $DAC$.
odpowiedz: |
  $\angle DAC = 45°$
pulapka: |
...
<MaterialZrodlowy
  src="/arkusze/matematyka/2025-maj-pr/ark-06.webp"
