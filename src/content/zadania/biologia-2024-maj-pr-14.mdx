...
difficulty: 3
tresc: |
  **Roztocza (Acari)** — szeroko rozprzestrzenione stawonogi (gleba, kurz, łoża pszczele, gorące źródła). Część to szkodniki upraw (np. *Brevipalpus phoenicis*) lub przyczyny **alergii**. Alergeny w odchodach roztoczy domowych wywołują katar, kichanie, łzawienie.

  **14.1.** Określ **gromadę** stawonogów, do której należy *B. phoenicis*. Podaj **jedną cechę budowy** świadczącą o przynależności.

  **14.2.** Uzupełnij zdanie o alergii: alergeny wiążą się z przeciwciałami IgE na powierzchni **komórek tucznych / limfocytów B**. Histamina powoduje **rozszerzenie / zwężenie** naczyń krwionośnych i **zwiększenie / zmniejszenie** przepuszczalności ścian naczyń.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-18.webp"
