...
difficulty: 4
tresc: |
  W probówkach I-IV (zwykła kolejność) — roztwory soli różnych metali. Po dodaniu NaOH w każdej powstaje **inna** zawiesina wodorotlenku: **Cr(OH)₃, Ca(OH)₂, Cu(OH)₂, Al(OH)₃**.

  **7.1.** Probówka I: **biała** zawiesina + HCl → klarowny → H₂SO₄ → ZAWIESINA. Probówka II: **biała** zawiesina + HCl → klarowny → H₂SO₄ → klarowny. Identyfikuj wodorotlenki I i II.

  **7.2.** Probówka III: zawiesina w łaźni wodnej → **czarny** osad (zdjęcie A). Probówka IV: zawiesina + NaOH → **zielony** roztwór (zdjęcie B). Równania:
  - Reakcja 1: cząsteczkowe równanie rozkładu termicznego (probówka III).
  - Reakcja 2: jonowe skrócone równanie roztwarzania (probówka IV).
odpowiedz: |
  **7.1.** Identyfikacja:
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-11.webp"
  alt="Zadanie 7.1-7.2"
  caption="Strona 11 arkusza CKE 2025 PR chemia - probówki I-IV, schematy + zdjęcia A (czarny CuO) i B (zielony chromian)."
  zrodlo="CKE 2025"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2025/Chemia/MCHP-R0-100-A-2505-arkusz.pdf"
  pdfPage={11}
/>
...
**7.1.**
- Wodorotlenek w probówce **I**: **Ca(OH)₂** (biały, daje CaSO₄ słabo rozpuszczalny → zawiesina po H₂SO₄).
- Wodorotlenek w probówce **II**: **Al(OH)₃** (biały, daje Al₂(SO₄)₃ rozpuszczalny → klarowny w obu krokach).

**7.2.**
- **Reakcja 1** (cząsteczkowa, probówka III, rozkład termiczny Cu(OH)₂):

$$\text{Cu(OH)}_2 \xrightarrow{\Delta} \text{CuO} + \text{H}_2\text{O}$$

- **Reakcja 2** (jonowo skrócona, probówka IV, roztwarzanie Cr(OH)₃ w NaOH):

$$\text{Cr(OH)}_3 + \text{OH}^- \rightarrow [\text{Cr(OH)}_4]^-$$

Probówka III = Cu(OH)₂ (niebieski → czarny CuO). Probówka IV = Cr(OH)₃ (amfoteryczny, w NaOH zielony chromian(III)).

</div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 7.1 — CaSO₄ słabo rozp.</div>

**Gips** = CaSO₄·2H₂O. **Praktycznie nierozpuszczalny** w wodzie (Ksp ≈ 4·10⁻⁵). Stąd: Ca²⁺ + SO₄²⁻ = **zawiesina**.

W zadaniu klucz: różnica między I a II = co stanie się z **siarczanem**. CaSO₄ strąca, Al₂(SO₄)₃ rozpuszcza.
</div>
