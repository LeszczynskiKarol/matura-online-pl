...
difficulty: 4
tresc: |
  **Storczyk Phalaenopsis 'Edessa'** — doświadczenie nad wpływem intensywności światła na zawartość chlorofilu.

  **Etap 1** (2 miesiące): wszystkie rośliny w **100 μmol/m²/s**, 28°C, 75% wilgotności.

  **Etap 2** (5 tygodni): podział na 2 grupy:
  - **LL** (low light) = 50 μmol/m²/s.
  - **HL** (high light) = 200 μmol/m²/s.

  Pomiary chlorofilu a, b, całkowitego + stosunku a/b w dniach 1, 4, 6, 10 (tygodni).

  **4.1.** Oceń P/F (ostatni dzień etapu 2):
  1. Chl a wyższy w LL niż HL.
  2. Chl całkowity w HL niższy o **ponad 300 mg/m²** niż w pierwszym dniu etapu 2.
  3. Stosunek a/b w LL przeszło **dwukrotnie** większy niż w HL.

  **4.2.** Cel pierwszego etapu — uprawy wszystkich roślin w **takich samych** warunkach.

  **4.3.** Cel pomiarów chlorofilu w **pierwszym dniu drugiego etapu**.
odpowiedz: |
  **4.1.**
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-08.webp"
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-09.webp"
  alt="Zadanie 4.1-4.3"
  caption="Strona 9 arkusza CKE 2023 PR biologia - polecenia 4.1, 4.2, 4.3."
  zrodlo="CKE 2023"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2023/Biologia/MBIP-R0-100-2305.pdf"
  pdfPage={9}
/>
