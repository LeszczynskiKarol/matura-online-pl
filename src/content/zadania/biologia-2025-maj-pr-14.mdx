...
difficulty: 4
tresc: |
  Schemat otrzymywania roślin transgenicznych z użyciem **Agrobacterium tumefaciens**: plazmid + obcy DNA → E1 → zrekombinowany plazmid → E2 → zrekombinowana komórka bakteryjna → infekcja komórki roślinnej → wbudowanie T-DNA z transgenem do chromosomu → hodowla in vitro → transgeniczna roślina.

  **14.1.** Uzupełnij tabelę: nazwa enzymu E1 i E2 (helikaza / ligaza / restryktaza) + funkcja.
  **14.2.** Wykaż, że **A. tumefaciens** pełni w tej metodzie funkcję **wektora**.
odpowiedz: |
  **14.1.**
...
<MaterialZrodlowy
  src="/arkusze/biologia/2025-maj-pr/ark-22.webp"
