...
**1.1.** Ograniczenie: podmokły teren / niestabilny grunt / wysokie wody podziemne. Cecha sprzyjająca: niewielka odległość od centrum / łatwy dojazd / płaski teren.

**1.2.** $L = 20\,\text{cm} \cdot 550\,\text{m/cm} = 11\,\text{km}$; $t = 11/4 = 2\,\text{h}\,45\,\text{min}$.

**1.3.** Dwie cechy z: wydłużony kształt / przepływowe / wyrównana linia brzegowa / zarastające brzegi.

**1.4.** Wiatr + deflacja/akumulacja/transport **lub** morze + abrazja/akumulacja/transport.

**1.5.** Czoło wydmy na **wschód** (wiatry zachodnie). Ramiona wolniej (wilgotniejszy / utrwalony piasek).
...
<div class="pulapka">
  ...
  **1.1**: Podanie cechy społecznej (np. "blisko szkoły") jako "przyrodniczego ograniczenia" — to nieprzyrodnicze, automatyczne 0 pkt za ten punkt.

  **1.2**: Pominięcie konwersji jednostek. Skala 1:55 000 → 1 cm = 55 000 cm = 550 m, **nie** 55 m ani 5,5 km.

  **1.3**: Podanie głębokości lub genezy — wykluczone z definicji zadania (CKE pisze "inne niż").

  **1.4**: Podanie czynnika **bez procesu** (np. "wiatr") albo procesu **bez czynnika** (np. "abrazja"). Wymagana **para**.

  **1.5**: "Wydmy idą na zachód, bo wiatr wieje z zachodu" — to **odwrotnie**. Wiatr z zachodu = **przesuwa** masę na wschód.
</div>
