...
difficulty: 3
tresc: |
  **Bezlist (*Buxbaumia*)** — wyjątkowy rodzaj mchu (prątniki). Gametofity:
  - **Męskie**: bardzo drobne, widoczne tylko pod mikroskopem.
  - **Żeńskie**: nierozgałęziona łodyżka do **1 mm** długości. Listki **zanikają** podczas dojrzewania sporofitu (przekształcają się w nitkowate twory).

  **Sporofit**: do **2 cm** wysokości. **Czerwona seta** + duża **puszka zarodni** — przynajmniej na początku rozwoju **zielona**.

  **6.1.** Wykaż, że dojrzały sporofit bezlistu pozyskuje związki organiczne **niezależnie** od gametofitu.
  **6.2.** Czy gametofit bezlistu jest **jednopienny** czy **dwupienny**? Uzasadnij.
  **6.3.** Uzupełnij zdania o przemianie pokoleń mchów: gametofity męskie są (haploidalne/diploidalne); z zygoty rozwija się sporofit wytwarzający w zarodni (identyczne/różne) genetycznie zarodniki.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-10.webp"
...
**6.1.** Sporofit bezlistu jest **fotosyntetycznie samodzielny**: jego **puszka zarodni jest zielona** = zawiera **chlorofil** = sporofit prowadzi **własną fotosyntezę**. Dodatkowo **gametofit żeński traci listki** podczas dojrzewania sporofitu → nie ma już aparatu fotosyntetycznego → fizycznie nie mógłby zaopatrywać sporofitu w związki organiczne. Sporofit jest więc **niezależny** od gametofitu pod względem odżywczym.

**6.2.** Gametofit bezlistu jest **dwupienny**. Uzasadnienie: gametofity **męskie** (drobne, mikroskopowe) i **żeńskie** (makroskopowe, do 1 mm) są **drastycznie różne** morfologicznie. Taka różnica wymaga **osobnych osobników** (różnych gametofitów) → dwupienność. Gdyby były jednopienne, oba typy występowałyby na tej samej roślinie.

**6.3.** Gametofity męskie mchów są **haploidalne** (n) — powstają z zarodników po mejozie, są jednociągowe. Z zygoty (diploidalna, 2n) rozwija się sporofit wytwarzający w zarodni **różne** genetycznie zarodniki — w zarodni zachodzi **mejoza**, każdy zarodnik to wynik niezależnej rekombinacji + crossing-over, więc każdy jest **unikatowy** genetycznie.

</div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 6.1 — "sporofit fotosyntetyzuje"</div>

Samo "sporofit fotosyntetyzuje" = niepełne. Trzeba **uzasadnić**: "zielona puszka = chlorofil = fotosynteza". Plus argument o **zaniku listków gametofitu** — że gametofit nie ma fizycznej możliwości karmić sporofitu.
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 6.2 — jednopienność u mchów</div>

Większość mchów jest **jednopienna** lub **dwupienna** — zależy od gatunku. Bezlist NIE jest typowym mchem. Klucz: **różna morfologia gametofitów** ♂ i ♀ = niemożliwe na jednej roślinie = **dwupienny**.
</div>
