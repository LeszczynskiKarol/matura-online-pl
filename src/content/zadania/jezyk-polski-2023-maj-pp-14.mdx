...
difficulty: 4
tresc: |
  Przeczytaj fragment *Wesela* Stanisława Wyspiańskiego (akt III, scena 19) oraz zapoznaj się z plakatem Piotra Kunce.

  **Fragment *Wesela***: Czepiec wzywa wszystkich do działania („Zbierajcie się, póki czas"). Krzyczy do Poety i Gospodarza: „Panowie, jakieście som, jeźli nie pójdziecie z nami, to my na was — i z kosami!". Poeta odpowiada pytaniem retorycznym: „Wiecież, kto my!? Co wy o nas wiecie — nic." Czepiec ripostuje: „O, pon, widno, niewidomy; widać, że nie znacie nas." Pan Młody dodaje: „Widzę, żeście krwi łakomy; jeno że na krew nie czas." (czyli: chcecie krwi, ale to nie czas na rewolucję).

  **Plakat Piotra Kunce** (do przedstawienia *Wesele*): przedstawia **dwie nogi założone jedna na drugą**. Górna noga ubrana w **strój inteligenta** (eleganckie spodnie, czarny but). Dolna noga w **stroju chłopskim** (biało-czerwone pasiaki, chłopski but). Sugestia: inteligencja **dominuje** nad chłopstwem (siedzi na nim, „depcze" go).
...
<div class="odpowiedz">
  <div>
„**Podobna**. Na plakacie przedstawiono dwie nogi założone jedna na drugą. Górna noga jest w stroju inteligenta, dolna — w stroju chłopa. Oznacza to, że **inteligencja stoi ponad chłopami i nimi dowodzi**.

We fragmencie *Wesela* chłopi (Czepiec) **domagają się od inteligencji dowodzenia akcją zbrojną** — uznają zwierzchność „panów". Czepiec mówi: „Panowie, jakieście som, jeźli nie pójdziecie z nami…". Jednak inteligencja **nie rozumie** Czepca — Poeta pyta: „Co wy o nas wiecie — nic." Z fragmentu wynika, że obie warstwy społeczne **niczego o sobie nie wiedzą**, mimo wzajemnej zależności. Plakat dobrze oddaje tę **hierarchiczną, ale niezrozumiałą** relację."
  </div>
</div>
