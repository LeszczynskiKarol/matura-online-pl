...
difficulty: 5
tresc: |
  Ekspresja informacji genetycznej u eukariontów: **transkrypcja → obróbka potranskrypcyjna (splicing) → translacja**.

  Schemat fragmentu **nici matrycowej DNA** (czytanej 3' → 5'):

  3'…**TATTA**tactgc[**TACGGGCGCACA**]**CACACT**[**ACGTATGCCATG**]**ACTCTC**[**ACAATT**]…5'

  - **Pomarańczowy TATTA** = sekwencja promotorowa.
  - **Niebieski CACACT, ACTCTC** = introny.
  - **Eksony w ramkach**: TACGGGCGCACA, ACGTATGCCATG, ACAATT.

  **18.1.** Jaką sekwencję będzie miał **dojrzały mRNA** (po splicingu)?
  ...
  **18.2.** Podaj sekwencję aminokwasową kodowaną przez **pierwszy ekson** (od końca N do C).
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-23.webp"
...
**18.1.** **D** — 5' AUGACGAUGCCCGCGUGUUGCAUACGGUACUGUUAA 3'. Powstaje z transkrypcji + wycięcia obu intronów (CACACT i ACTCTC).

**18.2.** Pierwszy ekson koduje: **Met – Pro – Ala – Cys** (Metionina – Prolina – Alanina – Cysteina). Cztery kodony: AUG-CCC-GCG-UGU.

</div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 18.1 — opcja C (pre-mRNA bez splicingu)</div>

Opcja C zawiera fragment intronu (GUGUGUG widoczne) — to pre-mRNA przed splicingiem. Klucz: zadanie pyta o **dojrzały** mRNA. Splicing musiał być wykonany.
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 18.2 — sekwencja DNA = sekwencja aa?</div>

NIE — sekwencja DNA musi najpierw zostać transkrybowana na mRNA (komplementarność + antyrównoległość), a dopiero potem translacja w trójkach (kodonach).
</div>
