...
tresc: |
  Trzy półogniwa:
  - **A**: MnO₄⁻ + 8 H⁺ + 5 e⁻ ⇌ Mn²⁺ + 4 H₂O  (E° = +1,51 V)
  - **B**: Br₂ + 2 e⁻ ⇌ 2 Br⁻  (E° = +1,07 V)
  - **C**: Co³⁺ + e⁻ ⇌ Co²⁺  (E° = +1,82 V)

  **14.1.** Aby pH malało w półogniwie A, [H⁺] musi się (zwiększać/zmniejszać) → proces (redukcji/utleniania) → drugie półogniwo pełni funkcję (anody/katody). Z którym półogniwem (B / C) połączyć A?

  **14.2.** Schemat ogniwa B + C generującego prąd.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-19.webp"
...
**14.1.**
- Aby pH malało, [H⁺] musi się **ZWIĘKSZAĆ**.
- W półogniwie A zachodzi proces **UTLENIANIA** (Mn²⁺ → MnO₄⁻, powstaje H⁺).
- Drugie półogniwo pełni funkcję **KATODY** (redukcja).
- Należy połączyć A z półogniwem **C** (E°(C)=1,82 > E°(A)=1,51, więc A jest anodą).

**14.2.** Schemat ogniwa B + C generującego prąd:

$$(-) \text{ Pt } | \text{Br}^-, \text{Br}_2 \,||\, \text{Co}^{3+}, \text{Co}^{2+} | \text{ Pt } (+)$$
...
<div class="pulapka">
  <div class="pulapka-label">Pułapka — konwencja schematu ogniwa</div>

Reguła IUPAC: schemat zapisany **od anody (-) do katody (+)**:
- Lewa strona: anoda + jej elektrolit.
- Klucz solny ||.
- Prawa strona: elektrolit katody + katoda.

Tak, by **SEM = E_prawej - E_lewej > 0** dla spontanicznego ogniwa.
</div>
