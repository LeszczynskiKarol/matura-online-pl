...
tresc: |
  ...
  - **Etap 1** (HVZ): kwas + Br₂/P → α-bromokwas (jeden H przy C α zamieniony na Br).
  - **Etap 2**: α-bromokwas + nadmiar NH₃ → **sól amonowa α-aminokwasu**.

  **Synteza B z kwasu propanowego**:
  - Kwas propanowy (CH₃CH₂COOH) → (Br₂/P) → A → (NH₃ aq, nadmiar) → B.

  **28.1.** Równanie cząsteczkowe reakcji 1 (wzory półstrukturalne).
  **28.2.** Równanie jonowe reakcji 2 (stosunek A:NH₃ = 1:3).
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-32.webp"
...
$$\text{CH}_3\text{-CH}_2\text{-COOH} + \text{Br}_2 \xrightarrow{P} \text{CH}_3\text{-CHBr-COOH} + \text{HBr}$$

(Bromowanie HVZ — selektywne na α-pozycji kwasu propanowego.)

**28.2.**

$$\text{CH}_3\text{-CHBr-COOH} + 3\,\text{NH}_3 \rightarrow \text{CH}_3\text{-CH(NH}_2\text{)-COO}^- + 2\,\text{NH}_4^+ + \text{Br}^-$$

(3 NH₃: 1 do substytucji Br→NH₂, 1 do neutralizacji HBr, 1 do neutralizacji -COOH.)

Produkt B = mieszana sól amonowa alaniny.
