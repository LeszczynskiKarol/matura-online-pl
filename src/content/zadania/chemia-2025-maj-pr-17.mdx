...
punkty: 2
typ: otwarte-krotkie
topic: chemia organiczna, alkeny, reguła Markownikowa, hydroboracja, addycja wody
difficulty: 5
tresc: |
  ...
  **Reakcja 1**: Alken + H₂O → CH₃-CH₂-**C(OH)(CH₂CH₃)**-CH₂-CH₃ (alkohol III-rzędowy = 3-etylo-3-pentanol).

  **Reakcja 2**: Alken + H₂O → CH₃-CH₂-CH(CH₃)-**CH₂-OH** (alkohol I-rzędowy = 2-metylo-1-butanol).
