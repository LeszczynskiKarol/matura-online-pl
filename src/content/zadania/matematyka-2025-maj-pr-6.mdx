...
difficulty: 5
tresc: |
  Ciąg $(a_n)$, określony dla każdej liczby naturalnej $n \geq 1$, jest geometryczny i zbieżny. W tym ciągu $a_1 + a_3 = 20$ oraz $a_1^2 + a_3^2 = 328$. Oblicz sumę wszystkich wyrazów tego ciągu. Rozważ wszystkie przypadki.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/matematyka/2025-maj-pr/ark-12.webp"
