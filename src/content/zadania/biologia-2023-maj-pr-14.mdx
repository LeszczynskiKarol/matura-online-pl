...
punkty: 4
typ: otwarte-krotkie
topic: kod genetyczny, translacja, mutacja punktowa, kodon STOP, aminokwasy, wyrodność kodu
difficulty: 5
tresc: |
...
**14.4.** **C** — jeden aminokwas może być kodowany przez więcej niż jeden kodon.

**Uzasadnienie**: kod genetyczny jest **wyrodny (zdegenerowany)** — większość aminokwasów (poza Met i Trp) ma **kilka kodonów** kodujących ten sam aa (np. Phe = UUU + UUC; Leu = 6 kodonów). Cecha **wyrodności** zwiększa odporność kodu na mutacje: zmiana 3. zasady kodonu często **NIE zmienia aa** (mutacja synonimowa).

Dlaczego nie inne opcje?:
- **A** — **uniwersalność** kodu (ten sam u różnych organizmów), nie wyrodność.
- **B** — **bez przecinków** (continuity), kolejne kodony stykają się bezpośrednio.
- **D** — **kolinearność** mRNA i polipeptydu.
