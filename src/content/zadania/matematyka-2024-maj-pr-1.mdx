...
difficulty: 3
tresc: |
  W chwili początkowej (t = 0) filiżanka z gorącą kawą znajduje się w pokoju, a temperatura kawy jest równa 80 °C. Temperatura w pokoju jest stała i równa 20 °C. Temperatura T tej kawy zmienia się zgodnie z zależnością T(t) = (T_p − T_z) · k^(−t) + T_z, gdzie T_p = 80, T_z = 20, k — stała. Po 10 minutach kawa ostygła do 65 °C. Oblicz temperaturę po kolejnych 5 minutach (czyli T(15)).
odpowiedz: |
  T(15) ≈ 59 °C
pulapka: |
