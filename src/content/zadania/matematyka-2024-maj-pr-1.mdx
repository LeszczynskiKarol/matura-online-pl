...
difficulty: 3
tresc: |
  W chwili początkowej ($t = 0$) filiżanka z gorącą kawą znajduje się w pokoju, a temperatura tej kawy jest równa $80\,°\mathrm{C}$. Temperatura w pokoju (temperatura otoczenia) jest stała i równa $20\,°\mathrm{C}$. Temperatura $T$ tej kawy zmienia się w czasie zgodnie z zależnością

  $$T(t) = (T_p - T_z) \cdot k^{-t} + T_z \quad \text{dla} \quad t \geq 0$$
  ...
  Po $10$ minutach, licząc od chwili początkowej, kawa ostygła do temperatury $65\,°\mathrm{C}$.
...
<MaterialZrodlowy
  src="/arkusze/matematyka/2024-maj-pr/zad-01.webp"
