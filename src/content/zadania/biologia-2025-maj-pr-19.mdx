...
difficulty: 3
tresc: |
  **Szpak balijski** (*Leucopsar rothschildi*) — endemit wyspy Bali. Krytycznie zagrożony. W 1990 r. tylko **15 osobników** w naturze (XX w. początek: 300-900). Powody wymierania: **degradacja siedlisk** + **kłusownictwo** na rynek ptaków śpiewających.

  Działania ochronne: wpis do **załącznika I CITES** (konwencja waszyngtońska), programy hodowli w niewoli + **reintrodukcja** osobników na Bali ze Stanów Zjednoczonych i Europy (skuteczne — populacja odnawiana).

  **19.1.** Dlaczego reintrodukcja powinna uwalniać osobniki z **różnych** programów hodowlanych (lokalnych + z różnych ogrodów zoo)? Uzasadnij genetycznie.
  **19.2.** Znaczenie wpisania szpaka do **załącznika I CITES** dla ochrony gatunku.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2025-maj-pr/ark-30.webp"
...
<MaterialZrodlowy
  src="/arkusze/biologia/2025-maj-pr/ark-31.webp"
  alt="Zadanie 19.2 - CITES"
  caption="Strona 31 arkusza CKE 2025 PR biologia - polecenie 19.2 (znaczenie CITES załącznik I)."
  zrodlo="CKE 2025"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2025/Biologia/MBIP-R0-100-A-2505-arkusz.pdf"
  pdfPage={31}
/>
