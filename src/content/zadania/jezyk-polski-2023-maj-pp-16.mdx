...
difficulty: 4
tresc: |
  Zadanie ma dwie części. Przeczytaj fragment *Roku 1984* George'a Orwella, w którym Syme tłumaczy zasady nowomowy: „Najwięcej, oczywiście, wyrzucamy czasowników i przymiotników, ale setki rzeczowników też są zupełnie zbędne. Usuwamy nie tylko synonimy, lecz także wyrazy przeciwstawne. […] Weźmy na przykład przymiotnik «dobry». Jeśli mamy «dobry», po co nam taki przymiotnik jak «zły»? «Bezdobry» wystarczy w zupełności. […] «Plusdobry» adekwatnie spełnia każdy wymóg, jeśli natomiast zachodzi potrzeba jeszcze większej emfazy, można użyć «dwaplusdobry». Z czasem pojęcie dobra i zła ograniczy się do zaledwie sześciu słów, a naprawdę do jednego."

  **16.1 (0-1)** — Spośród podanych określeń (A-D) wybierz to, które charakteryzuje nowomowę stworzoną w państwie opisanym w powieści *Rok 1984*. Zaznacz właściwą odpowiedź.
  ...
  **16.2 (0-1)** — Na podstawie powieści *Rok 1984* George'a Orwella wyjaśnij, czemu służyło stworzenie nowomowy.
odpowiedz: |
