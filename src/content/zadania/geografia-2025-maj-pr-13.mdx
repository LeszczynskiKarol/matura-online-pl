...
**13.1.** Klimatogramy dopasowane: 11°N → równikowy/podrównikowy; 33°S → śródziemnomorski.

**13.2. — PF**

**13.3.** Strome granitowe stoki + chroniony las tropikalny Tijuca + zagrożenie osuwiskami.
...
<div class="pulapka">
  ...
  **13.2: Pomylenie kierunku Prądu Brazylijskiego.** Prąd Brazylijski idzie **na S** (zgodnie z cyrkulacją zwrotnikową — w hemisferze S wiry wirują przeciwnie do wskazówek zegara). Klucz: ciepłe prądy idą od równika **w stronę biegunów**.

  **13.3: Wymienienie wody.** Treść **wyraźnie** wyklucza wody powierzchniowe. Wymienienie "ocean blokuje rozbudowę" = -1 pkt.

  **13.3: Stereotypowe odpowiedzi.** "Wysokie temperatury, wilgotność" — to klimat, ale niewystarczające. CKE chce **konkretu** (stoki, las, osuwiska).
</div>
