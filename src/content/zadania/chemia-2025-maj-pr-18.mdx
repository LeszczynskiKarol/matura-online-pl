...
difficulty: 4
tresc: |
  **p-ksylen** (1,4-dimetylobenzen) reaguje z bromem:
  - **Pod wpływem światła** (hν).
  - **W obecności żelaza** (Fe jako katalizator).

  Uzupełnij tabelę: typ reakcji (addycja / eliminacja / substytucja) + mechanizm (elektrofilowy / nukleofilowy / rodnikowy).
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-24.webp"
