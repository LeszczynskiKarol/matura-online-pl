...
difficulty: 5
tresc: |
  Podstawą ostrosłupa $ABCDS$ jest kwadrat $ABCD$. Krawędź boczna $SA$ jest wysokością ostrosłupa, natomiast krawędź podstawy ma długość $3\sqrt{34}$. Cosinus kąta $\beta$ między ścianami bocznymi $CDS$ i $BCS$ tego ostrosłupa jest równy $-\dfrac{9}{25}$. Oblicz pole powierzchni bocznej tego ostrosłupa.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/matematyka/2025-maj-pr/ark-20.webp"
