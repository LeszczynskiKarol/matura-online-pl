...
<div class="odpowiedz">
  <div>
„Marek Edelman, jako dowódca Żydowskiej Organizacji Bojowej, stał przy bramie Umschlagplatzu i wyciągał z tłumu skazanych na zagładę poszczególne osoby, ratując im życie. Pamięć o tych wydarzeniach **stała się dla niego życiowym imperatywem** — po wojnie, jako kardiochirurg, kontynuuje to samo zadanie: **wyrywa pacjentów śmierci**. Sam mówi, że „stoi przy tej bramie przez całe życie" — pamięć łączy w jedno doświadczenie getta i salę operacyjną.

**Sens tytułu** *Zdążyć przed Panem Bogiem* odsyła do tej misji: Edelman jako lekarz chce **podjąć działanie zanim Bóg „zgasi czyjąś świecę"** — uratować pacjenta przed śmiercią. A jeśli nie da się uratować, chce zdążyć z **komfortową śmiercią**, by człowiek nie cierpiał, nie bał się, nie poniżał. Tytuł oddaje antyfatalistyczną postawę Edelmana — człowiek nie czeka na decyzję Boga, lecz aktywnie walczy o życie."
  </div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka — pominięcie tytułu</div>

CKE wymaga DWÓCH elementów:
1. **Rola pamięci** o Umschlagplatzu w życiu Edelmana.
2. **Sens tytułu** reportażu.

Jeśli omówisz tylko jedno z nich — maks 1 pkt zamiast 2. Strategia: skończ wyjaśnienie roli pamięci akapitem „Sens tytułu…" lub „Tytuł reportażu…".
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka — Umschlagplatz to nie obóz</div>

**Umschlagplatz** = rampa przeładunkowa W WARSZAWIE, skąd transportowano Żydów do Treblinki. To nie obóz koncentracyjny ani obóz zagłady. Ważne, by nazwać go poprawnie — to plac SELEKCJI i WYWOZÓW.

Pomieszanie z Treblinką czy Auschwitz → CKE może uznać za błąd faktograficzny → mniej punktów.
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka — getto vs powstanie warszawskie</div>

Dwa różne wydarzenia:

- **Powstanie w getcie warszawskim** — kwiecień-maj 1943, Żydzi przeciwko Niemcom, dowódcy: Mordechaj Anielewicz, Marek Edelman.
- **Powstanie warszawskie** — sierpień-październik 1944, Armia Krajowa, dowódca: gen. Bór-Komorowski.

Edelman był w POWSTANIU W GETCIE 1943. Pomylenie tych dwóch — błąd merytoryczny, ryzyko utraty punktów.
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka — tylko streszczenie fragmentu</div>

CKE wprost: „**na podstawie podanego fragmentu ORAZ całego reportażu**". Czyli nie wystarczy parafraza tego, co czytasz — trzeba pokazać znajomość całej książki.

Strategia: powołaj się na konkretne wątki z reportażu: praca z Anielewiczem w ŻOB, kontekst getta, powojenne operacje serca, polemika z hagiograficznym wizerunkiem powstańców.
</div>
