...
difficulty: 4
tresc: |
  **Pierwiastek E**: elektrony w stanie podstawowym zajmują **osiem orbitali**, przy czym **sześć** jest całkowicie zapełnionych.

  **Pierwiastek X**: konfiguracja w jednym ze stanów **wzbudzonych**:
  - 1s² 2s² 2p⁶ 3s¹ 3p³ 3d³

  **1.1.** Tabela: symbole E i X, symbol bloku konfiguracyjnego, liczba elektronów walencyjnych.

  **1.2.** Liczby kwantowe (główna n, poboczna l) niesparowanego elektronu **atomu E w stanie podstawowym**.

  **1.3.** Pełna konfiguracja elektronowa **jonu X⁻** w stanie podstawowym.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-04.webp"
