...
**4.1.** D1 (Kiry) — skały **mezozoiczne** (wapienie, dolomity). B6 (Błyszcz) — skały **paleozoiczne** (granity, trzon krystaliczny).

**4.2. — A2**: trasa 1, dzięki obecności **skał węglanowych wieku mezozoicznego**.
...
<div class="pulapka">
  ...
  **Pomylenie skał krasowych**. Kras powstaje **tylko** w skałach **węglanowych** (CaCO₃) — wapieniach i dolomitach. W granitach, piaskowcach, gnejsach **nie ma krasu** (mogą być natomiast formy wietrzenia mrozowego, gołoborza).

  **Pomylenie ery i okresu**. Era to **dłuższy** podział czasu (paleozoik, mezozoik, kenozoik). Okres to **krótszy** (kambr, ordowik, sylur, dewon... jura, kreda...). CKE pyta o **wiek skał** = era + okres.

  **Pomylenie płaszczowin z trzonem**:
  - **Trzon krystaliczny** = jądro Tatr Wysokich (paleozoik, granity).
  - **Płaszczowiny** = warstwy nasunięte na trzon (mezozoik, skały osadowe).
</div>
