...
difficulty: 3
tresc: |
  **Amfisbeny (Amphisbaenia)** — zwierzęta żyjące głównie pod powierzchnią ziemi w wydrążonych przez siebie tunelach. Używają głowy do drążenia, więc czaszka uległa wzmocnieniu. Ciało **długie, cienkie, pokryte twardymi, suchymi rogowymi łuskami** ułożonymi w pierścienie wokół ciała. **Okresowe zrzucanie naskórka** w postaci wylinki.

  **8.1.** Amfisbeny należą do (A. pierścienic / B. stawonogów / **C. gadów**), o czym świadczy (1. okresowe zrzucanie naskórka / 2. segmentowa budowa / 3. wydłużone ciało).

  **8.2.** Czaszki amfisben przystosowały się do drążenia tuneli w wyniku:
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-14.webp"
...
<MaterialZrodlowy
  ...
  alt="Zadanie 8.2"
  caption="Strona 15 arkusza CKE 2023 PR biologia - polecenie 8.2 (mechanizm adaptacji)."
  zrodlo="CKE 2023"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2023/Biologia/MBIP-R0-100-2305.pdf"
  pdfPage={15}
/>
...
**8.1.** **C1** — amfisbeny należą do **gadów** (Reptilia, Squamata), o czym świadczy **okresowe zrzucanie naskórka w postaci wylinki** (ekdyza rogowego naskórka — cecha diagnostyczna gadów łuskoskórnych: węży, jaszczurek, amfisben).

**8.2.** **D — dobór naturalny**. Czaszki amfisben uległy wzmocnieniu, ponieważ osobniki z mocniejszymi czaszkami **łatwiej drążyły tunele** → lepiej zdobywały pokarm + uciekały drapieżnikom → przeżywały i rozmnażały się częściej → przekazywały geny. Po pokoleniach cecha "mocna czaszka" utrwaliła się w populacji.
