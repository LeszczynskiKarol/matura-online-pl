...
difficulty: 3
tresc: |
  **Retrowirusy** (np. HIV) — materiał genetyczny: jednoniciowy **RNA**. Po wniknięciu do komórki wprowadzają enzym — **odwrotną transkryptazę**, która przepisuje RNA wirusa na DNA.

  Odwrotna transkryptaza HIV: 2 podjednostki **p66** (czerwona) + **p51** (pomarańczowa). p66 ma **dwa aktywne obszary**: **polimerazy** + **rybonukleazy**.

  Uzupełnij tabelę: funkcja każdego obszaru w procesie przepisywania RNA → DNA.
odpowiedz: |
  | Obszar | Funkcja |
  |---|---|
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-05.webp"
