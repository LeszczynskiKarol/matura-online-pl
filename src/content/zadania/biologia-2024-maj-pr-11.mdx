...
difficulty: 3
tresc: |
  Schemat tułowia człowieka z 4 lokalizacjami gruczołów dokrewnych:
  - **A** — szyja, poziom krtani.
  - **B** — klatka piersiowa, między płucami (mostek).
  - **C** — nad nerkami.
  - **D** — brzuch, obok żołądka.

  Tabela funkcji:
  1. Wydziela **hormony peptydowe** regulujące stężenie glukozy we krwi.
  2. Odgrywa kluczową rolę w **dojrzewaniu układu odpornościowego**.
  3. **Część korowa** wydziela hormony **steroidowe** (kortyzol + niewielkie ilości androgenów).
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-15.webp"
