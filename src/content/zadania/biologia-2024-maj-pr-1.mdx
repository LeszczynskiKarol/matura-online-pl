...
difficulty: 3
tresc: |
  Polimery organizmów: białka, cukry, kwasy nukleinowe — różne monomery + różne wiązania.

  **1.1.** Tabela polimerów: białka + cukry (monosacharyd). Uzupełnij: nazwa monomeru + typ wiązania (glikozydowe / fosfodiestrowe / peptydowe) + przykład funkcji.

  **1.2.** Dopasuj opisy A-D do struktur białkowych:
  - **I-rzędowa**
  - **II-rzędowa**
  - **III-rzędowa**

  A. Stabilizowana oddziaływaniami między **osobnymi** łańcuchami polipeptydowymi.
  B. Część łańcucha zwinięta w regularną strukturę **wyłącznie wiązaniami wodorowymi**.
  C. Przestrzenne ułożenie **pojedynczego** łańcucha — niekowalencyjne + kowalencyjne (mostki S-S).
  D. **Kolejność** reszt aminokwasowych w łańcuchu.
odpowiedz: |
  **1.1.** Tabela:
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-04.webp"
...
| Grupa | Monomer | Wiązanie | Funkcja |
|---|---|---|---|
| **białka** | **aminokwas** | **peptydowe** | budulcowa |
| **cukry** | monosacharyd | **glikozydowe** | zapasowa |
...
<div class="pulapka">
  <div class="pulapka-label">Pułapka 1.2 — opis A</div>

Opis **A** ("osobnych łańcuchów") **NIE pasuje** do struktur I-III. To **IV-rzędowa**. CKE nie pyta o IV — A jest dystraktorem. Częsty błąd: dopisanie A do którejś ze struktur niższego rzędu.
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 1.1 — fosfodiestrowe</div>

**Fosfodiestrowe** = wiązania w **DNA/RNA**, NIE w polisacharydach. Patrząc na tabelę: "monosacharyd" → polisacharyd → wiązanie **glikozydowe**.
</div>
