...
**Odpowiedź: B3** — rewitalizacja, która polega na ożywieniu zdegradowanych obszarów miast i zmianie ich funkcji.
...
<div class="pulapka">
  ...
  **Pomylenie rewitalizacji z reindustrializacją.** **Rewitalizacja** = zmiana funkcji (przemysł → kultura). **Reindustrializacja** = nowy przemysł na starym terenie (technologie zaawansowane). W EC1 NIE ma już przemysłu — tylko kultura.

  **Pomylenie z renowacją / restauracją.** **Renowacja** = przywrócenie pierwotnego stanu. **Rewitalizacja** = **głębsza zmiana** + **funkcja społeczna** + **zmiana użytkowania**.
</div>
