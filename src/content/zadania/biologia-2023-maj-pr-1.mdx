...
tresc: |
  ...
  **Reakcja pomostowa**: pirogronian + CoA-SH + NAD⁺ → acetylo-CoA + CO₂ + NADH + H⁺. Katalizuje ją **kompleks dehydrogenazy pirogronianowej** (3 enzymy: E₁, E₂, E₃).

  Schemat: E₁ (niebieski) → CO₂ + przejście; E₂ (pomarańczowy) ↔ CoA-SH/acetylo-CoA; E₃ (zielony) ↔ NAD⁺/NADH+H⁺.

  **1.1.** Dopasuj typ reakcji do enzymu (E₁ / E₂ / E₃): **transacetylacja, dehydrogenacja, dekarboksylacja**.

  **1.2.** Gdzie znajduje się aktywny kompleks dehydrogenazy pirogronianowej?
  A. cytozol / B. macierz mitochondrialna / C. zewnętrzna błona mt / D. wewnętrzna błona mt / E. przestrzeń międzybłonowa.

  **1.3.** Wykaż, że funkcjonowanie kompleksu jest **konieczne** do połączenia glikolizy z cyklem Krebsa.

  **1.4.** Wykaż, że **zmniejszenie aktywności** kompleksu prowadzi do **wzrostu stężenia mleczanu** w komórce mięśnia szkieletowego.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-04.webp"
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-05.webp"
  alt="Zadanie 1.2-1.4"
  caption="Strona 5 arkusza CKE 2023 PR biologia - podpunkty 1.2, 1.3, 1.4."
  zrodlo="CKE 2023"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2023/Biologia/MBIP-R0-100-2305.pdf"
  pdfPage={5}
/>
