...
**Okres A** (niskie przepływy): retencja śnieżna / zamarznięcie → mały spływ.

**Okres B** (wysokie przepływy): wezbranie roztopowe → intensywne topnienie śniegu → wzmożony spływ powierzchniowy.
...
<div class="pulapka">
  ...
  **Brak mechanizmu** — odpowiedź "zimą rzeka ma mało wody" jest **niewystarczająca**. CKE wymaga **dlaczego** (retencja śnieżna, zamarznięcie, niskie opady).

  **Pominięcie jednego okresu** — automatyczne -1 pkt. Zawsze pisz **OBA** uzasadnienia A i B.

  **Mylenie wezbrania roztopowego z opadowym**. Roztopowe = topnienie śniegu (marzec-kwiecień). Opadowe = intensywne opady letnie (czerwiec-lipiec, burze).
</div>
