...
difficulty: 3
tresc: |
  **tRNA** (transferowe RNA) — cząsteczka pośrednicząca w translacji (transkrypcji → translacja → białko).

  Struktura 3D widoczna na schemacie: kształt "**L**" (lub "kupą" liścia koniczyny w 2D), z **ramieniem akceptorowym** (koniec 3', wierzchołek) + **antykodonem** (pętla na dole).

  **17.1.** Cząsteczki tRNA zbudowane są z (A. jednej / B. dwóch) nici. Komplementarne odcinki nici położone są w (1. przeciwnej / 2. tej samej) orientacji.

  **17.2.** Określ funkcję ramienia **akceptorowego** + funkcję **antykodonu**.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2024-maj-pr/ark-22.webp"
...
**17.1.** **A1** — tRNA zbudowane z **jednej** nici. Komplementarne odcinki położone są w **przeciwnej** (antyrównoległej) orientacji.

**17.2.**
- **Ramię akceptorowe**: **przyłącza odpowiedni aminokwas** na końcu 3' (sekwencja CCA-3'). Reakcja katalizowana przez aminoacylo-tRNA-syntetazę. Aminoacylo-tRNA wnosi aminokwas do rybosomu.
- **Antykodon**: **rozpoznaje kodon mRNA** podczas translacji. Trzy nukleotydy antykodonu wiążą się komplementarnie i antyrównoległe z trzema nukleotydami kodonu mRNA → zapewnia precyzję wbudowania aminokwasu zgodnie z kodem genetycznym.

</div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 17.1 — "dwie nici"</div>

Wygląd tRNA na schemacie ZA WYDAJE się jak dwie nici, ale to **jedna** nić zawinięta. Klucz: jeden gen tRNA → jedna nić → 76 nukleotydów.

Porównanie:
- **DNA** = dwie osobne nici (komplementarne) → dwuniciowe.
- **mRNA / tRNA / rRNA** = jedna nić (może się sama składać).
</div>

<div class="pulapka">
  <div class="pulapka-label">Pułapka 17.2 — "transport aminokwasów"</div>

Sama "transport" = niepełne. Klucz: **co dokładnie robi każde ramię**:
- Akceptorowe: **WIĄŻE** aminokwas (chemiczne wiązanie estrowe).
- Antykodon: **ROZPOZNAJE** kodon (parowanie zasad).

Bez tych funkcji translacja byłaby ślepa lub nie miałaby aminokwasów do przyłączania.
</div>
