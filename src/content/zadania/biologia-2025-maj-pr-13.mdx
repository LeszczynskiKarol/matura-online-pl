...
difficulty: 4
tresc: |
  ADC (antibody-drug conjugate) — lek celowany: przeciwciało monoklonalne + łącznik chemiczny + toksyczna substancja. Po związaniu z antygenem nowotworowym kompleks ulega endocytozie do komórki nowotworowej, a lizosom uwalnia toksynę.

  **13.1.** Wyjaśnij, dlaczego ADC dostarcza toksynę **tylko** do komórek nowotworowych.
  **13.2.** Wykaż, że **stabilność łącznika** podczas transportu w krążeniu jest konieczna do prawidłowego działania leku.
  **13.3.** Rola **lizosomów** w mechanizmie ADC.
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/biologia/2025-maj-pr/ark-20.webp"
...
<MaterialZrodlowy
  src="/arkusze/biologia/2025-maj-pr/ark-21.webp"
  alt="Zadanie 13.1-13.3"
  caption="Strona 21 arkusza CKE 2025 PR biologia - polecenia 13.1, 13.2, 13.3."
  zrodlo="CKE 2025"
  pdfUrl="https://cke.gov.pl/images/_EGZAMIN_MATURALNY_OD_2023/Arkusze_egzaminacyjne/2025/Biologia/MBIP-R0-100-A-2505-arkusz.pdf"
  pdfPage={21}
/>
