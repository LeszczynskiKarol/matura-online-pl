...
difficulty: 4
tresc: |
  Doświadczenie losowe polega na czterokrotnym rzucie symetryczną sześcienną kostką do gry. Oblicz prawdopodobieństwo zdarzenia polegającego na tym, że otrzymamy **co najmniej jeden raz** sześć oczek, pod warunkiem że otrzymamy **dokładnie dwa razy** pięć oczek.
odpowiedz: |
  $P(A | B) = \dfrac{9}{25}$
pulapka: |
...
<MaterialZrodlowy
  src="/arkusze/matematyka/2025-maj-pr/ark-08.webp"
