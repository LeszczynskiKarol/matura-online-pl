...
difficulty: 3
tresc: |
  **Rozszczepienie ciężkich jąder**: jądro bombardowane neutronem dzieli się na **2 lżejsze fragmenty** + emisja **2-3 neutronów**.

  **Reakcja**: ²³⁵U + n → ?·n + ⁹²₃₆Kr + ¹⁴¹₅₆Ba

  **2.1.** Uzupełnij schemat reakcji (liczba neutronów + ich liczba masowa/atomowa + liczby przy U i n).

  **2.2.** ²³⁵U + n → ⁹³Sr + 3n + ? (¹³⁹I / ¹⁴⁰Xe / ¹⁴⁰Ba). Większy N/Z: ²³⁵U / ⁹³Sr?
odpowiedz: |
...
<MaterialZrodlowy
  src="/arkusze/chemia/2025-maj-pr/ark-05.webp"
...
- **Lekkie jądra** (Z<20): stabilne przy N/Z ≈ 1 (np. ¹²C: N=6, Z=6, N/Z=1).
- **Średnie** (Z 20-50): N/Z ≈ 1,2-1,3.
- **Ciężkie** (Z>50): N/Z **rośnie** do ~1,5-1,6 (np. ²³⁵U: 143/92 ≈ 1,55).
