...
difficulty: 5
tresc: |
  **Labradory retrievery** — 3 fenotypy koloru sierści: **czarna, brązowa, żółta**. Dwa loci:

  - **Locus E**: allel dominujący **E** = wytwarzanie pigmentu (ciemna sierść). Allel recesywny **e** = brak pigmentu (sierść jasna = żółta). U homozygot **ee** sierść zawsze jest żółta — niezależnie od locus B (**epistaza recesywna**).

  - **Locus B**: allel dominujący **B** = sierść czarna. Allel recesywny **b** = sierść brązowa. Działa tylko gdy E_ (jest pigment).

  Pies o sierści żółtej **NIE wskazuje** na genotyp w B — niewidoczna.

  **Krzyżówka**: żółta samica + brązowy samiec, mający **po jednym recesywnym allelu w obu loci** (heterozygota w drugim locus). Skrzyżowanie pokazuje rozkład fenotypów + prawdopodobieństwo ciemnego nosa u żółtych szczeniąt.

  **15.** Zapisz krzyżówkę + stosunek fenotypowy + P(żółte szczenię ma ciemny nos).
odpowiedz: |
  **Genotypy rodziców**:
...
<MaterialZrodlowy
  src="/arkusze/biologia/2023-maj-pr/ark-24.webp"
