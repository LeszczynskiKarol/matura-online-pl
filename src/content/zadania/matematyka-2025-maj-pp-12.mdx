...
<div class="odpowiedz">
  <div>
    <strong>Odpowiedź 12.1:</strong> $f(x) = -\dfrac{1}{3}(x - 3)^2 + 6$.
  </div>
</div>
...
<div class="odpowiedz">
  <div>
    <strong>Odpowiedź 12.2: A</strong> — $x = 3$.
  </div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Typowy błąd 12.2</div>

**Odpowiedź C ($y = 6$)** — wybiera ten, kto myli **oś symetrii** z **wartością ekstremalną**. $y = 6$ to **wysokość wierzchołka**, NIE oś symetrii.

Oś symetrii paraboli kwadratowej to ZAWSZE prosta **pionowa** (równanie $x = \text{coś}$), nigdy pozioma. Pamiętaj: parabola jest symetryczna „lewo-prawo" względem pionowej osi przez wierzchołek.
</div>
...
<div class="odpowiedz">
  <div>
    <strong>Odpowiedź 12.3:</strong> $x_1 + x_2 = 6$.
  </div>
</div>

<div class="pulapka">
  <div class="pulapka-label">Wzór Viète'a — sprawdzenie</div>

Sposób III (najszybszy): wzór Viète'a dla $g(x) = -\tfrac{1}{3}(x-3)^2 + 3$.

Rozwiń: $-\tfrac{1}{3}(x^2 - 6x + 9) + 3 = -\tfrac{1}{3}x^2 + 2x - 3 + 3 = -\tfrac{1}{3}x^2 + 2x$.

Z Viète'a dla $-\tfrac{1}{3}x^2 + 2x = 0$:

$$x_1 + x_2 = -\frac{b}{a} = -\frac{2}{-1/3} = 6$$

Trzy różne ścieżki, ten sam wynik.
</div>
